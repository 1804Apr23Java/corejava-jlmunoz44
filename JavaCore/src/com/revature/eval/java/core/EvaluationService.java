...
public class EvaluationService {
	...
	static class BinarySearch<T> {
		...
		public int indexOf(T t) {
			...
			//while(left <= right) {
			//if(t.compareTo(this.sortedList.get(midpoint))) {
	...
	public String toPigLatin(String string) {
		...
		if (string.startsWith("kn")) {
			...
			case 'y': string = string.substring(1); string = string.concat("yay"); break;
			case 'b': string = string.substring(1); string = string.concat("bay"); break;
			case 'c': string = string.substring(1); string = string.concat("cay"); break;
			case 'd': string = string.substring(1); string = string.concat("day"); break;
			case 'f': string = string.substring(1); string = string.concat("fay"); break;
			case 'g': string = string.substring(1); string = string.concat("gay"); break;
			case 'h': string = string.substring(1); string = string.concat("hay"); break;
			case 'j': string = string.substring(1); string = string.concat("jay"); break;
			case 'k': string = string.substring(1); string = string.concat("kay"); break;
			case 'l': string = string.substring(1); string = string.concat("lay"); break;
			case 'm': string = string.substring(1); string = string.concat("may"); break;
			case 'n': string = string.substring(1); string = string.concat("nay"); break;
			case 'p': string = string.substring(1); string = string.concat("pay"); break;
			case 'q': string = string.substring(1); string = string.concat("qay"); break;
			case 'r': string = string.substring(1); string = string.concat("ray"); break;
			case 's': string = string.substring(1); string = string.concat("say"); break;
